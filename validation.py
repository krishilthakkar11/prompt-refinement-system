"""
Validation Logic: Defines essential vs optional information
This module explicitly defines what makes a prompt valid or invalid
"""
...
class PromptValidator:
    ...
    def validate(self, refined_prompt: dict) -> dict:
        """
        Validate a refined prompt and return validation result
        
        Args:
            refined_prompt: The refined_prompt portion of the output
        
        Returns:
            Dict with is_valid_prompt, rejection_reason, completeness_score
        """
        validation_result = {
